    ...
    if (this.batchid) {
      ...
      this.service.getBatchById(this.batchid).then(res => {
        ...
        this.myform = new FormGroup({
          ...
          name: new FormControl(this.batch.name,[Validators.required,Validators.minLength(2)]),
          duration: new FormControl(this.batch.duration, [Validators.required,Validators.minLength(2)]),
          descr: new FormControl(this.batch.descr,[Validators.required,Validators.minLength(2)]),
          time: new FormControl(this.batch.time,[Validators.required,Validators.minLength(2)]),
